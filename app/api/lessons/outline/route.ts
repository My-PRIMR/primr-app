...
function buildSystemPrompt(blockRange: string): string {
  return `You are an expert instructional designer. Given a lesson title, topic description, target audience, level, and optional scope/focus, generate a lesson outline as JSON.
...
export async function POST(req: NextRequest) {
  ...
  const systemPrompt = buildSystemPrompt(blockRange)
